...
public class TaskFinishAdapter extends RecyclerView.Adapter<TaskFinishAdapter.TaskViewHolder> {
    ...
    public TaskFinishAdapter(List<TaskVO> myList, View.OnClickListener mOnClickListener) {
        this.myList = myList;
    ...
    public TaskViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.findViewById(R.id.checkbox_finish).setOnClickListener(mOnClickListener);
